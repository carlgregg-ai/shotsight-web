...
export const P7_ENGINEERING_GUN_STRATEGY=Object.freeze({
  id:'ENGINEERING_INTERCEPT_REFERENCE',
  provenanceClass:'ENGINEERING_REFERENCE',
  status:'NOT_A_COACHING_METHOD',
  description:'Bore continuously follows the instantaneous physical intercept solution for integration/debug validation only.'
});
...
export function createCanonicalFlatCrosserScenario({targetInitial_W=[-6,35,1.5],targetVelocity_W=[15,0,0],shotOrigin_W=[0,0,1.5],cameraOrigin_W=[0,0,1.65],R_CW=P7_DEFAULT_CAMERA_R_CW,shotTime_s=0.8,methodRegistryId='NSCA_LONG_CROSSER_PULL_AWAY',provider=createTestOnlyConstantSpeedProvider()}={}){
  ...
  return Object.freeze({id:'P7_FLAT_CROSSER_ENGINEERING_PROOF_V1',status:'ENGINEERING_PROOF_NOT_REALISTIC_CLAY_CERTIFICATION',targetInitial_W:Object.freeze([...targetInitial_W]),targetVelocity_W:Object.freeze([...targetVelocity_W]),shotOrigin_W:Object.freeze([...shotOrigin_W]),cameraOrigin_W:Object.freeze([...cameraOrigin_W]),R_CW,shotTime_s,gunStrategy:P7_ENGINEERING_GUN_STRATEGY,methodEntry,provider,limitations:Object.freeze(['constant-velocity target','TEST_ONLY constant-speed pellet provider','straight pellet path','no realistic clay aerodynamics','no dense shot-cloud model','engineering intercept-reference gun strategy is NOT a coaching method','source method is reference-only; method-specific kinematics and threshold-dependent coaching states remain held'])});
}
